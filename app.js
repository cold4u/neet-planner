...
async function startAiParse() {
  ...
  document.getElementById('ai-loading-desc').textContent = "Extracting questions, options, subject tags, and explanations directly from your document. Please wait...";
